...
if __name__ == '__main__':
    ...
    source_position_inf_d1 = get_source_position(angle_inf_h + 3.0, angle_inf_v, radius=6.0)
    source_position_inf_d2 = get_source_position(angle_inf_h - 3.0, angle_inf_v, radius=6.0)
    ...
    d_arr_inf_d1        = propagation_vector_free_field(sensor_positions, source_position_inf_d1, N_fft = n_fft, F_s = sr)
    d_arr_inf_d2        = propagation_vector_free_field(sensor_positions, source_position_inf_d2, N_fft = n_fft, F_s = sr)
