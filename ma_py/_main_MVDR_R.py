...
#    _noise_end     = 7
    ...
    # eigenvals, eigenvecs = np.linalg.eigh(psd_noise_matrix)
    # vals = np.argmax(eigenvals[15], axis=-1)
    # print (vals)
    # print (np.abs(eigenvecs[15,vals]))
    ...
    sf.write(r"out/out_mvdr.wav", sig_out, sr)
