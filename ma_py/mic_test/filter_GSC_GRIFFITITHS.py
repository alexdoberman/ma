...
class GSC_GRIFFITITHS_FILTER(BaseFilter):

    def __init__(self, mic_config, logger_flag=True, logger_level='DEBUG'):
        super(GSC_GRIFFITITHS_FILTER, self).__init__(mic_config, logger_flag, logger_level)
    ...
    def do_filter(self, in_wav_path, out_wav_path, filter_cfg, mic_cfg, **kwargs):
        ...
        result_spec = gsc_griffiths_filter(stft_all, d_arr.T)
