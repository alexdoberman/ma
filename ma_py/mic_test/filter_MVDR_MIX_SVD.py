...
from mic_py.beamforming import get_mvdr_vector_svd


class MVDR_MIX_SVD_FILTER(BaseFilter):

    def __init__(self, mic_config, logger_flag=True, logger_level='DEBUG'):
        super(MVDR_MIX_SVD_FILTER, self).__init__(mic_config, logger_flag, logger_level)
    ...
    def do_filter(self, in_wav_path, out_wav_path, filter_cfg, mic_cfg, **kwargs):
        ...
        w = get_mvdr_vector_svd(d_arr.T, psd, type_reg=type_reg, r=reg_p)
