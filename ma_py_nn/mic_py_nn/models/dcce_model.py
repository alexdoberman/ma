...
class DCCEModel(BaseModel):
    ...
    Inputs:
        ...
        num_speakers: Number of unique speakers to train on. only use in training.
        ...
        normalize: Do you normalize vectors coming into the final layer? (default False)
        device: Which device to run the model on
    """

    def __init__(self, config):
        super(DCCEModel, self).__init__(config)
