...
from mic_py_nn.data_generator.batchers.base_batchers import STFTBatcher, MaskBatcher

from mic_py_nn.models.ugan_model import UGANModel
from mic_py_nn.trainers.ugan_trainer import UGANTrainer
from mic_py_nn.trainers.ugan_predict import UGANPredict
...
def main():
    ...
    trainer = UGANTrainer(sess, model, train_data, valid_data, config, logger)
    trainer.train()
    ...
    #################################################################
    # 7 - Predict result
    predictor = UGANPredict(sess, model, config)
